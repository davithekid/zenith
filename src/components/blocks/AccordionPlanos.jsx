            ...
            <div className="px-3">
                ...
                <AccordionItem value="item-1">
                    ...
                    <AccordionContent className="flex flex-col gap-4 text-balance">
                        <p>
                            O <strong>Plano Essencial</strong> é ideal para quem está começando:
                            oferece acesso limitado às funcionalidades essenciais e suporte por e-mail.
                        </p>
                        <p>
                            O <strong>Plano Avançado</strong> amplia sua experiência com relatórios
                            detalhados, suporte prioritário e integração com múltiplas plataformas.
                        </p>
                        <p>
                            Já o <strong>Plano Mestre</strong> garante acesso total a todas as ferramentas,
